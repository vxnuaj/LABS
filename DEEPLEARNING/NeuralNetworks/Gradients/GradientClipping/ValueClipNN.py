...
def backward(x, one_hot_y, w2, a2, a1, z1, k):
    ...
    # implementation of gradient value clipping
    # issue here is that norm of a gradient vector isn't proportionally maintained. 
    # the direction of the overall gradient will change, a solution is norm clipping
