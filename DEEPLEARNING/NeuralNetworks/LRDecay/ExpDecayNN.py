...
def update(w1, b1, w2, b2, dw1, db1, dw2, db2, alpha, epoch, k):


    ''' Learning Rate, Exponential Decay '''

    alpha = alpha * np.exp(-k * epoch)
...
def grad_descent(x, y, w1, b1, w2, b2, epochs, alpha, k, file):
    ...
    for epoch in range(epochs):
        ...
        w1, b1, w2, b2, alpha = update(w1, b1, w2, b2, dw1, db1, dw2, db2, alpha, epoch, k)
...
if __name__ == "__main__":
    ...
    w1, b1, w2, b2 = model(X_train, Y_train, 500, .1, .0001, file)
