...
def update(w1, b1, w2, b2, dw1, db1, dw2, db2, alpha_max, alpha_min, cycle_size, epoch):
...
def grad_descent(x, y, w1, b1, w2, b2, epochs, alpha_max, alpha_min, alpha_vec, acc_vec, cycle_size, file):
    one_hot_y = one_hot(y)
    for epoch in range(epochs):
        ...
        w1, b1, w2, b2, alpha = update(w1, b1, w2, b2, dw1, db1, dw2, db2, alpha_max, alpha_min, cycle_size, epoch)
...
def model(x, y, epochs, alpha_max, alpha_min, alpha_vec, acc_vec, cycle_size, file):
    ...
    w1, b1, w2, b2, alpha_vec, acc_vec = grad_descent(x, y, w1, b1, w2, b2, epochs, alpha_max, alpha_min, alpha_vec, acc_vec, cycle_size, file)
...
if __name__ == "__main__":
    ...
    w1, b1, w2, b2, alpha_vec, acc_vec = model(X_train, Y_train, epochs = 600, alpha_max = .55, alpha_min = .08, alpha_vec=alpha_vec, acc_vec = acc_vec, cycle_size = 200, file = file)

    plt.plot(alpha_vec, acc_vec)
