...
### Textbook Notes ( beginning $\rightarrow$ 48)

- If we had a system of equations with 3 unknowns, to produce every point in a given $Col(A)$ or $span$ of $A$ we'd need at least 3 equations because as minimum, we need the same number of equations to unknowns.